...
class VerificationItemController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return response()->json(['success' => true, 'message' => 'Barang berhasil diajukan untuk verifikasi', 'data' => $item]);
    }
    ...
    public function verify(Request $request, $id)
    {
        ...
        // Simpan ke tabel incoming_items (asumsi model IncomingItem sudah ada)
        ...
        $item->verified_by = Auth::user()->name ?? 'admin';
