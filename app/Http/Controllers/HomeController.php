...
use App\Models\Producer; // Import Data
    ...
    public function index()
        {
            ...
            } elseif ($user->role === 'staff_admin') { // Perbarui bagian ini
                return view('home', [
                    'dashboardView' => 'dashboard.staff_admin_dashboard', // Arahkan ke dashboard staff_admin
                    'incomingItems' => $incomingItems, // Teruskan data untuk ringkasan
                    'outgoingItems' => $outgoingItems, // Teruskan data untuk ringkasan
                ]);
            }
