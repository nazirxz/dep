        ...
        <div class="auth-card">
            ...
            <div class="auth-brand-side">
                <div class="brand-content">
                    ...
                    <h2 class="brand-title">Reset Kata Sandi</h2>
            ...
            <div class="auth-form-side">
                <div class="form-content">
                    <div class="form-header">
                        <h4 class="form-title">Kata Sandi Baru</h4>
                        <p class="form-subtitle">Buat kata sandi yang aman untuk akun Anda</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('password.update') }}" class="auth-form" id="resetPasswordForm">
                        ...
                        <button type="submit" class="btn-reset" id="resetBtn">
                            <span class="btn-text">Reset Kata Sandi</span>
...
<style>
/* Inherit base styles from login and forgot password */
html, body {
    height: 100%;
    overflow: hidden;
    margin: 0;
